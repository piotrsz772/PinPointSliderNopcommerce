...
{
    public partial class PinPointSliderObjectContext : DbContext, IDbContext
    {
        #region Ctor

        public PinPointSliderObjectContext(DbContextOptions<PinPointSliderObjectContext> options) : base(options)
        {
        }
        ...
        {
            modelBuilder.ApplyConfiguration(new PinPointSliderTableMap());
        ...
        {
            //drop the table
            this.DropPluginTable(nameof(PinPointSliderTableMap));
        }
